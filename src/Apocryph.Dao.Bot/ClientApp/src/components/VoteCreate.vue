		...
		<form>
			<fieldset>
				...
				<div class="form-group">
					...
					<input type="text" id="contractAddress" name="contractAddress" v-model="contractAddress"
						:disabled="success" />
				</div>
				...
				<div class="form-group">
					<div class="button-grid">
						<div class="form-group">
							...
							<input id="title" name="title" type="text" v-model="title" :disabled="success" />
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<textarea id="description" name="description" rows="10" v-model="description" :disabled="success" />
				</div>

				<div class="form-group">
					<label for="actionsBytes">Actions Bytes:</label>
					<textarea type="text" id="actionsBytes" name="actionsBytes" rows="10" v-model="actionsBytes"
						:disabled="success" />
				</div>

				<div class="form-group">
					<div class="button-grid">
						<button class="btn btn-default" role="button" name="createVoteProposal" id="createVoteProposal"
							@click="createVoteProposal" v-if="!success">
		...
		methods: {
			async createVoteProposal(e) {
				...
				try {
					...
					await contract.propose(rationaleHash, actionsHash)
